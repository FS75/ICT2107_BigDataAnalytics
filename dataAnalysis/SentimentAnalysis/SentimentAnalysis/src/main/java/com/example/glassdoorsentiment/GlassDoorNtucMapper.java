...
public class GlassDoorNtucMapper extends Mapper<LongWritable, Text, Text, DoubleWritable>{
	...
	protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
	    ...
	    double totalSentimentScore = sentimentScore1 + sentimentScore2;

	    // emit the total sentiment score for the company as a DoubleWritable value
	    String companyName = "NtucFairpriceGlassDoor";
